...
try {
    ...
    $ajaxMap = [
        ...
        'mesa_multiplos_pedidos' => 'mesa_multiplos_pedidos.php',
        'ver_mesa_multiplos_pedidos' => 'mesa_multiplos_pedidos.php',
        'fechar_pedido_individual' => 'mesa_multiplos_pedidos.php',
        'fechar_mesa_completa' => 'mesa_multiplos_pedidos.php',
