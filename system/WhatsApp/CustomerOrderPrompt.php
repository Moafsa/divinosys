...
- Se o cliente perguntar sobre seus pedidos, histórico, itens/produtos consumidos ou detalhes de pedidos, use consultar_pedidos_cliente passando o "tipo" adequado (ativos ou historico).
PROMPT;
    }
}
