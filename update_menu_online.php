<?php
/**
 * Script para limpar e recriar dados do cardápio online
 * Baseado nos cardápios fornecidos
 * 
 * Acesso: http://seu-dominio.com/update_menu_online.php
 */
...
<head>
    ...
    <title>Atualização do Cardápio - Divino Lanches</title>
    <style>
...
try {
    ...
    foreach ($categories as $category) {
        $categoryId = $db->insert('categorias', [
            'nome' => $category['nome'],
    ...
    foreach ($ingredients as $ingredient) {
        $ingredientId = $db->insert('ingredientes', [
        ...
        foreach ($product['ingredientes'] as $ingredientName) {
            if (isset($ingredientIds[$ingredientName])) {
                $db->insert('produto_ingredientes', [
                    ...
                    'ingrediente_id' => $ingredientIds[$ingredientName],
                    'obrigatorio' => true
                ]);
            }
        }
