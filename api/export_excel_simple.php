<?php
// Simple Excel Export - Alternative implementation
...
try {
    ...
    switch ($action) {
        case 'export_products':
            exportProductsSimple($pdo, $tenantId, $filialId);
            break;
            
        case 'export_categories':
            exportCategoriesSimple($pdo, $tenantId, $filialId);
            break;
            
        case 'export_ingredients':
            exportIngredientsSimple($pdo, $tenantId, $filialId);
            break;
            
        case 'export_orders':
            exportOrdersSimple($pdo, $tenantId, $filialId);
            break;
            
        case 'export_financial':
            exportFinancialSimple($pdo, $tenantId, $filialId);
            break;
            
        case 'export_paid_orders':
            exportPaidOrdersSimple($pdo, $tenantId, $filialId);
            break;
            
        case 'export_credit_orders':
            exportCreditOrdersSimple($pdo, $tenantId, $filialId);
            break;
...
function exportProductsSimple($pdo, $tenantId, $filialId) {
    ...
    $excelContent = createSimpleExcelFile($products, [
        'ID' => 'id',
        'Código' => 'codigo', 
        'Nome' => 'nome',
        'Descrição' => 'descricao',
...
function exportCategoriesSimple($pdo, $tenantId, $filialId) {
    ...
    $excelContent = createSimpleExcelFile($categories, [
        'ID' => 'id',
        'Nome' => 'nome',
        'Descrição' => 'descricao',
        'Ativo' => 'ativo',
...
function exportIngredientsSimple($pdo, $tenantId, $filialId) {
    $whereClause = "WHERE tenant_id = ?";
    $params = [$tenantId];
    ...
    $excelContent = createSimpleExcelFile($ingredients, [
        'ID' => 'id',
        'Nome' => 'nome',
        'Preço' => 'preco',
        'Ativo' => 'ativo',
...
function exportOrdersSimple($pdo, $tenantId, $filialId) {
    $whereClause = "WHERE p.tenant_id = ?";
    $params = [$tenantId];
    ...
    $excelContent = createSimpleExcelFile($orders, [
        'ID' => 'idpedido',
        'Mesa' => 'mesa',
...
function exportPaidOrdersSimple($pdo, $tenantId, $filialId) {
...
function exportCreditOrdersSimple($pdo, $tenantId, $filialId) {
...
function exportFinancialSimple($pdo, $tenantId, $filialId) {
    ...
    $excelContent = createSimpleExcelFile($lancamentos, [
        'ID' => 'id',
        'Tipo' => 'tipo',
        'Valor' => 'valor',
...
function createSimpleExcelFile($data, $columnMapping, $sheetName) {
    // Create a simple Excel-compatible XML file
